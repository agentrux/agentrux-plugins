...
| **Trigger** (`agentrux-trigger`) | Trigger plugin | Topic への新着 event で workflow を起動する | [`dify-agentrux-trigger-1.0.9.difypkg`](./dify-agentrux-trigger-1.0.9.difypkg) |
...
2. [`dify-agentrux-trigger-1.0.9.difypkg`](./dify-agentrux-trigger-1.0.9.difypkg) をアップロード
