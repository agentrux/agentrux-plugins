...
|-----------|-------------|
| **AgenTrux Connection** | Authenticate with script_id + secret, optionally redeem a grant token. Produces a reusable client. |
...
2. Fill in `base_url`, `script_id`, and `secret`.
